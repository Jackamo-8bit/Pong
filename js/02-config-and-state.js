...
function buildSkinGrid(){
  ...
  Object.entries(SKINS).forEach(([key,s])=>{
    ...
    const decoMidline=s.deco?`<polygon points="40,10 43,15 40,20 37,15" fill="${s.fg}" opacity=".15"/><polygon points="40,22 43,27 40,32 37,27" fill="${s.fg}" opacity=".15"/><polygon points="40,34 43,39 40,44 37,39" fill="${s.fg}" opacity=".15"/><circle cx="40" cy="25" r="12" fill="none" stroke="${s.fg}" stroke-width=".5" opacity=".1"/>`:s.zen?`<path d="M40,0 Q44,12 38,25 Q42,38 40,50" stroke="#3d6835" stroke-width="1" fill="none" opacity=".3"/><ellipse cx="44" cy="15" rx="3" ry="1.5" fill="#4a7a40" opacity=".2"/><ellipse cx="36" cy="35" rx="3" ry="1.5" fill="#4a7a40" opacity=".2"/>`:s.bauhaus?`<line x1="40" y1="0" x2="40" y2="50" stroke="#f0e8d0" stroke-width="1.5" opacity=".12"/><circle cx="40" cy="12" r="3" fill="none" stroke="#f0e8d0" stroke-width=".5" opacity=".1"/><circle cx="40" cy="38" r="3" fill="none" stroke="#f0e8d0" stroke-width=".5" opacity=".1"/>`:`<line x1="40" y1="0" x2="40" y2="50" stroke="${s.midline}" stroke-width="1" stroke-dasharray="4,4"/>`;
    const decoPaddle=s.deco?`<rect x="2" y="12" width="10" height="2" fill="${s.fg}"/><rect x="3" y="14" width="8" height="20" fill="${s.fg}"/><rect x="2" y="34" width="10" height="2" fill="${s.fg}"/><rect x="68" y="12" width="10" height="2" fill="${s.fg}"/><rect x="69" y="14" width="8" height="20" fill="${s.fg}"/><rect x="68" y="34" width="10" height="2" fill="${s.fg}"/>`:s.bauhaus?`<rect x="4" y="14" width="4" height="22" fill="#cc2222"/><rect x="72" y="14" width="4" height="22" fill="#cc2222"/>`:`<rect x="4" y="12" width="${s.paddleShape==='thin'?4:6}" height="26" rx="${rx}" fill="${s.fg}"/><rect x="${s.paddleShape==='thin'?72:70}" y="12" width="${s.paddleShape==='thin'?4:6}" height="26" rx="${rx}" fill="${s.fg}"/>`;
